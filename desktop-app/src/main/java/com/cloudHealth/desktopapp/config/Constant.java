...
public class Constant {
    public static final String ACCESS_TOKEN_URL ="http://localhost:8282/authorization-service/oauth/token";
    public static final String CLIENT_ID ="mobile";
    public static final String CLIENT_SECRET ="pin";
    public static final String ACCESS_TOKEN_FILE = "user-access-token.json";
    public static final String CHECK_TOKEN_URL = "http://localhost:8282/authorization-service/oauth/token";
    private static final String MAIN_SERVICE_BASE_URL ="http://localhost:8282/medical-records-service/api/v1";
    ...
    public static final String HEALTH_PRACTITIONER = MAIN_SERVICE_BASE_URL+"/register/practitioner";
    public static final String HEALTH_UNIT = MAIN_SERVICE_BASE_URL+"/healthUnit";
}
